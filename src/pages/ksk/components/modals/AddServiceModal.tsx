    ...
    <Modal isOpen={isOpen} onClose={handleClose} title="Создать сервис">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs font-semibold text-slate-600 mb-1">Компания / провайдер *</label>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-600 mb-1">
              Контактное лицо <span className="text-slate-400 font-normal">необязательно</span>
            </label>
